...
class StackedCNN(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=2, stride=1, padding=0) #(64, 10, 12, 12)
        self.bn2 = nn.BatchNorm2d(10)
        self.flatten = nn.Flatten() #(64, 6*6*10)
        self.fc1 = nn.Linear(6*6*10, 10) # I expect input of shape (64, 1, 28 28)
...
predictor = StackedCNN().to(device)
#%%
